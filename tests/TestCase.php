...
namespace JeffersonGoncalves\FilamentCommerce\Inventory\Tests;
...
use JeffersonGoncalves\FilamentCommerce\Inventory\FilamentCommerceInventoryServiceProvider;
use JeffersonGoncalves\FilamentCommerce\Inventory\Tests\Fixtures\TestPanelProvider;
use JeffersonGoncalves\FilamentCommerce\Inventory\Tests\Fixtures\TestUser;
...
abstract class TestCase extends CommerceFilamentTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            FilamentCommerceInventoryServiceProvider::class,
